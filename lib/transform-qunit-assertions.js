...
import supportedAssertions from './supported-assertions.js';
import { types as _types, print, parse, visit } from 'recast';
var builders = _types.builders;
var types = _types.namedTypes;
...
function isTestCall(node) {
  return types.Identifier.check(node.callee) && node.callee.name === 'test';
}
