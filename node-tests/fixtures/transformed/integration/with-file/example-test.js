...
test('it works', async function(assert) {
  ...
  assert.ok(await Promise.resolve(2), 'assert.ok(await Promise.resolve(2)) at example-test.js:8:2');
  assert.ok(class Person {}, 'assert.ok(class Person {}) at example-test.js:9:2');
