...
test('it works', function(assert) {
  ...
  assert.strictEqual((function() { return true; })(), (function() { return true; })(),'assert.strictEqual((function() { return true; })(), (function() { return true; })())');
  assert.strictEqual(1, 1, 'testing equality');
  assert.strictEqual(true, true, 'assert.strictEqual(true, true)');
  assert.strictEqual((1+2+3)-3*5*6, -84, 'assert.strictEqual((1+2+3)-3*5*6, -84)');
  ...
  assert.strictEqual(testFunction(true), testFunction(true), 'assert.strictEqual(testFunction(true), testFunction(true))');
});
